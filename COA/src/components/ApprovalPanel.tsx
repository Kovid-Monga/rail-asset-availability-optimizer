	...
	return (
		<div className="space-y-4">
			<div className="flex flex-wrap items-center justify-between gap-3">
				<div>
					<div className="flex items-center gap-2">
						...
						{block.is_combined ? (
							<span className="rounded-md border border-line bg-raised px-2 py-0.5 text-[11px]">
			...
			{block.conflict_reason ? (
				<div className="flex gap-2.5 rounded-lg border border-[#C0392B]/45 bg-[#C0392B]/10 p-3.5">
					<AlertTriangle size={15} className="mt-0.5 shrink-0 text-[#C0392B]" />
					<div>
						<p className="text-[12.5px] font-semibold text-[#C0392B]">Conflict detected</p>
			...
			{block.planner_override ? (
				<div className="rounded-lg border border-[#C2610F]/45 bg-[#C2610F]/10 p-3.5">
					<p className="flex items-center gap-1.5 text-[12.5px] font-semibold text-[#C2610F]">
				...
				<ul className="space-y-1.5">
					{members.map((t) => (
						<li
							key={t.task_id}
							className={cx(
								"flex items-center gap-2.5 rounded-lg border border-line bg-raised px-3 py-2 text-[12.5px]",
			...
			{editing ? (
				<div className="space-y-3 rounded-lg border border-line bg-raised p-3.5">
